...
function Home() {
  return (
    ...
    <div>
      ...
      <h1 className="main-text font-russo text-[74px] text-gradient-to-r from-[#5A38FD]">
        CKM
      </h1>
      <ul className="flex">
        <a href="#Partners"><li className="p-4 font-russo text-[24px] hover:scale-125 ease-linear duration-300 text-[#3B1EC5]">
          Partners
        </li></a>
        <a href="#Price"><li className="p-4 font-russo text-[24px] hover:scale-125 ease-linear duration-300 text-[#3B1EC5]">
          Pricing
        </li></a>
       <a href="#About"> <li className="p-4 font-russo text-[24px] hover:scale-125 ease-linear duration-300 text-[#3B1EC5]">
          About Us
        </li></a>
      ...
      <a href="/login" className=" bg-indigo-800 font-russo text-white rounded p-2 px-6">Login</a>
    </div>
    {/* Hero Section */}
      <div className="flex max-w-[1240px] mx-auto px-4 pt-10">
        <div className=" w-[50%]">
          ...
          <p className=" text-[#0C147A] font-russo text-[24px]">
      ...
      {/* Information Section */}
      <div id="About" className="max-w-[1240px] mx-auto px-4 pt-10 border-b-gray-900">
      ...
      <div className="flex justify-between pt-10">
        ...
        <div className=" text-left pl-8 ">
          ...
          <button
            className=" bg-indigo-800 text-white px-8 py-2 rounded-lg font-russo hover:scale-105 duration-150 ease-out "
          >
            Get Started
          </button>
        </div>
    ...
    {/* Pricing */}
    <div id="Price" className="flex flex-col max-w-[1240px] mx-auto px-4 pt-10">
        <h1 className="text-center underline font-russo text-indigo-800 text-2xl">Pricing</h1>
      <div className="flex items-center justify-center py-10">
        <h1 className=" font-russo text-4xl">Start Growing 10x faster with&nbsp;</h1>
        <TypeAnimation
          sequence={[
            "CKM", // Types 'One'
            1500,
