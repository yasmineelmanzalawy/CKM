        ...
        <div className="flex flex-col items-center md:flex-col">
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 gap-2">
            ...
            <div className="block max-w-sm p-6 mb-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
              ...
              <p className="font-normal text-gray-700">
                Unlock the potential of your cloud kitchen business with CKM's
                comprehensive suite of tools, empowering you to deliver
                exceptional customer experiences while simplifying your
