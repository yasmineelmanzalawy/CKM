        ...
        >
          ...
          <div class="mx-24 md:grid md:grid-cols-3 gap-4 justify-items-center pt-[80px]">
            <div>
              <label
                for="Raw Material"
                className="text-center block pb-2 text-lg font-medium text-gray-900 dark:text-white"
              >
                Item Name
              </label>
              <input
            ...
            <div>
              ...
              <select
                className="w-[300px] text-center px-14 bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                value={data.category}
                onChange={handleChange}
                name="category"
              >
                <option className="text-center hidden" value="select">
                  select
                </option>
                <option className="text-center" value="dry_goods">
                  dry_goods
                </option>
                <option className="text-center" value="meats">
                  meats
                </option>
                <option className="text-center" value="seafood">
                  seafood
                </option>
                <option className="text-center" value="vegetables">
                  vegetables
                </option>
                <option className="text-center" value="legume">
                  legume
                </option>
                <option className="text-center" value="spices">
                  spices
                </option>
                <option className="text-center" value="herbs">
                  herbs
                </option>
                <option className="text-center" value="others">
                  others
                </option>
                <option className="text-center" value="liquid">
                  liquid
                </option>
              </select>
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="number"
                id="Quantity"
                className="text-center w-[300px] px-2 bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div className="text-center">
              ...
              <select
                ...
                className="mt-2 h-[48px] w-[300px] text-center bg-gray-50 border px-16 border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block  py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              >
                <option className="text-center hidden" value="select">
                  Select
                </option>
                <option className="text-center" value="kilograms">
                  kilograms
                </option>
                <option className="text-center" value="Grams">
                  Grams
                </option>
                <option className="text-center" value="liters">
                  Liters
                </option>
              </select>
            </div>
