            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">Chiken Burger</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      ...
                      <span class="font-medium">Italian Pasta</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">Sea Food Pizza</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">BBQ Pizza</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">Red Spaghetti</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                ...
                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="font-medium">White Spaghetti</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
